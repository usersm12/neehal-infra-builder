...
export const productCategories: ProductCategory[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { name: "Tile Grout", description: "Fine-finish grout for joints between tiles." },
      { name: "Bonding Agent", description: "Improves adhesion between old and new concrete surfaces." },
    ],
  },
  {
    ...
    products: [
      { name: "Non Shrink Grout", description: "Precision grouting for equipment bases and anchor bolts." },
      { name: "Polymer Repair Mortar", description: "Structural repair for damaged concrete surfaces." },
      { name: "Crack Filler", description: "Fast-setting filler for surface cracks in walls and floors." },
      { name: "Self Leveling Flooring", description: "Smooth, self-leveling base for industrial and commercial floors." },
      { name: "Floor Hardener", description: "Dust-proofing and hardening for industrial concrete floors." },
      { name: "Light Weight Block Joint Mortar", description: "For AAC block jointing with minimal wastage." },
      { name: "Ready Mix Plaster", description: "Factory-made plaster for consistent wall finishes." },
      ...
      { name: "Rust Converter", description: "Converts rust to stable compound before painting." },
      { name: "Rust Remover", description: "Removes rust from metal surfaces." },
      { name: "Bituminous Products", description: "Waterproofing and protection for below-grade structures." },
      ...
      { name: "Wall Putty", description: "Smooth base coat for interior walls before painting." },
      { name: "Anti Corrosive", description: "Protection for steel structures and surfaces." },
      { name: "Fiber Resa", description: "Polypropylene fiber for crack resistance in concrete." },
      { name: "Protective Coating", description: "High-performance coatings for industrial surfaces." },
