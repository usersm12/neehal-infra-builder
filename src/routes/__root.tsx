...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Neehal Infra Builder is a 5-page business website for an authorized Redwop Chemicals dealer." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Neehal Infra Builder is a 5-page business website for an authorized Redwop Chemicals dealer." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Neehal Infra Builder is a 5-page business website for an authorized Redwop Chemicals dealer." },
